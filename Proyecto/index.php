            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-start">
              <div class="member aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
                <div class="member-info text-center">
                  ...
                  <span>Muñecas</span>
                  <p>De rodillas al suelo, colocamos los antebrazos encima de la pelota o foam roller y rodamos desde codo a muñecas </p>
                  <p>En posición de cuadrupedia movilizamos nuestras muñecas con el peso de nuestro cuerpo hacia delante y hacia atrás, hacia los lados o realizando círculos. También podemos apoyar el dorso de la mano.</p>
                </div>
              </div>
            </div>
