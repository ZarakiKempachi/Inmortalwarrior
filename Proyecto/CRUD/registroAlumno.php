...
function registro($username, $nombre, $apellidos, $email, $passwd )
{
  ...
  $sql1 = "INSERT INTO usuarios (Nombre, Apellido, Email,Username, `Password`,Fecha_Creacion,foto,Is_Admin,Is_Instructor, ID_Boxes) VALUES ( '$nombre','$apellidos', '$email', '$username', '$passwd',NOW(),'',0,'','')";
