            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="wods col-md-6 col-lg-4  mb-4">
                        <a href="thegirls.html" class="image-container">
                    ...
                    <div class="wods col-md-6 col-lg-4  mb-4">
                        <a href="theheroes.html" class="image-container">
                    ...
                    <div class="wods col-md-6 col-lg-4  mb-4">
                        <a href="desafios.html" class="image-container">
                    ...
                    <div class="wods col-md-6 col-lg-4  mb-4">
                        <a href="distancias.html" class="image-container">
                    ...
                    <div class="wods col-md-6 col-lg-4 mb-4" class="image-container">
                        <a href="qualifiers.html" class="image-container">
                    ...
                    <div class="wods col-md-6 col-lg-4  mb-4" class="image-container">
                        <a href="programas.html" class="image-container">
