...
$sql_total = "SELECT COUNT(*) as total FROM wods WHERE tipo = 'Programas'";
...
$sql_pagina = "SELECT * FROM wods WHERE tipo = 'Programas' LIMIT $inicio, $resultados_por_pagina";
...
<a href="#" onclick="history.back();"  class=" btn  "><i class="bi  bi-arrow-left " ></i></a>
    <div class="container mt-5">
        ...
        <div class="text-center">
            <p>Aquí puedes encontrar todos los wod`s de Programas.</p>
        </div>
